...
class Config(object):
    ...
    API_ID = 22332222# integer value, dont use ""
    API_HASH = "abdfc348d1350682e9323888af8cd7f4"
    TOKEN = ""  # This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    OWNER_ID =  6248129136 # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Shinu_han"
    SUPPORT_CHAT = "https://t.me/botkilda"  # Your own group for support, do not add the @
    JOIN_LOGGER = (
        -1002241612045
    )  # Prints any new group the bot is added to, prints just the name and ID.
    EVENT_LOGS = (
